...
import codeGridBanner from "../../assets/codeGridBanner.svg";
import AuthContext from "../../context/AuthProvider.jsx";
import { ROLES } from "../../constants.jsx";
import Loader from "../Loader.jsx";
import ROUTE_CONSTANTS from "./contants";
import UserPopup from "./components/UserPopUp.jsx";
import UserSVG from "./components/UserSVG.jsx";
    ...
    <nav className="sticky top-0 z-20 flex items-center justify-between py-3 bg-white shadow-sm md:px-28">
      <NavLink to="/">
        <button className="flex items-center gap-2 -ml-5 sm:ml-0">
          <img src={codeGridBanner} alt="codeGridBanner" />
          {/* <img className='cursor-pointer' width='60px' src={codegrid} alt='Logo' /> */}
        </button>
      </NavLink>
